...
/**
 * 
 * @requires widgets/IncidentiEditPopup.js
 */

/** api: (define)
 *  module = gxp.plugins
 *  class = IncidentiEditor
 */
...
/** api: constructor
 *  .. class:: IncidentiEditor(config)
 *
 *    Plugin for feature editing. Requires a
 *    :class:`gxp.plugins.FeatureManager`.
 */   
gxp.plugins.IncidentiEditor = Ext.extend(gxp.plugins.FeatureEditor, {
    
    /** api: ptype = gxp_incidentieditor */
            ...
            "featureselected": function(evt) {
                ...
                if(this.selectControl.active) {
                    popup = this.addOutput({
                        xtype: "gxp_icidentieditpopup",
                        collapsible: true,
                        target:this.target,
                        feature: feature,
                        incidentiConfig:this.incidentiConfig||null,
...
Ext.preg(gxp.plugins.IncidentiEditor.prototype.ptype, gxp.plugins.IncidentiEditor);
