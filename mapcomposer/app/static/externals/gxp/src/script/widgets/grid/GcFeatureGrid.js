 ...
 */
gxp.grid.GcFeatureGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    onDestroy: function() {
        ...
        gxp.grid.GcFeatureGrid.superclass.onDestroy.apply(this, arguments);
    },
...
Ext.reg('gxp_gcfeaturegrid', gxp.grid.GcFeatureGrid); 
